...
foreach ($variant in $variants) {
    $buildParams = @{
        ...
        DisableAccountSigninBuild = $true
    }
    ...
    $targetName = "BBCLauncherbeta_1.0.399.0_x64_$($variant.Name)_public.msix"
...
$manifestPath = Join-Path $releaseDir "BBCLauncherbeta_1.0.399.0_public_sha256.json"
